...
class Ui_RouterWidget(object):
    def setupUi(self, RouterWidget):
        ...
        self.maskLine = QtGui.QLineEdit(self.verticalLayoutWidget)
        self.maskLine.setObjectName(_fromUtf8("maskLine"))
        self.horizontalLayout_2.addWidget(self.maskLine)
    ...
    def retranslateUi(self, RouterWidget):
        ...
        self.maskLine.setText(_translate("RouterWidget", "Mask", None))
