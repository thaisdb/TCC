...
class Ui_NewMainWindow(object):
    def setupUi(self, NewMainWindow):
        ...
        NewMainWindow.resize(1301, 841)
        self.centralwidget = QtGui.QWidget(NewMainWindow)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.stackedWidget = QtGui.QStackedWidget(self.centralwidget)
        self.stackedWidget.setGeometry(QtCore.QRect(10, -20, 1271, 781))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(40, 60, 1211, 611))
        ...
        spacerItem1 = QtGui.QSpacerItem(50, 50, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Maximum)
        ...
        spacerItem2 = QtGui.QSpacerItem(20, 50, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Maximum)
