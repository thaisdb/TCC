...
static const char qt_meta_stringdata_QPyDesignerTaskMenuExtension[] = {
    "QPyDesignerTaskMenuExtension\0"
};
...
const QMetaObjectExtraData QPyDesignerTaskMenuExtension::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QPyDesignerTaskMenuExtension::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QPyDesignerTaskMenuExtension,
      qt_meta_data_QPyDesignerTaskMenuExtension, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QPyDesignerTaskMenuExtension::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPyDesignerTaskMenuExtension))
