...
#line 29 "/home/thais/Faculdade/TCC/NEW/PyQt4_gpl_x11-4.12/QtGui/sipQtGuiQX11Info.cpp"
...
PyDoc_STRVAR(doc_QX11Info_appClass, "appClass() -> str");
...
PyDoc_STRVAR(doc_QX11Info_screen, "screen(self) -> int");
...
PyDoc_STRVAR(doc_QX11Info_depth, "depth(self) -> int");
...
PyDoc_STRVAR(doc_QX11Info_cells, "cells(self) -> int");
...
PyDoc_STRVAR(doc_QX11Info_colormap, "colormap(self) -> int");
...
PyDoc_STRVAR(doc_QX11Info_defaultColormap, "defaultColormap(self) -> bool");
...
PyDoc_STRVAR(doc_QX11Info_visual, "visual(self) -> sip.voidptr");
...
PyDoc_STRVAR(doc_QX11Info_defaultVisual, "defaultVisual(self) -> bool");
...
PyDoc_STRVAR(doc_QX11Info_appDepth, "appDepth(screen: int = -1) -> int");
...
PyDoc_STRVAR(doc_QX11Info_appCells, "appCells(screen: int = -1) -> int");
...
PyDoc_STRVAR(doc_QX11Info_appColormap, "appColormap(screen: int = -1) -> int");
...
PyDoc_STRVAR(doc_QX11Info_appVisual, "appVisual(screen: int = -1) -> sip.voidptr");
...
PyDoc_STRVAR(doc_QX11Info_appDefaultColormap, "appDefaultColormap(screen: int = -1) -> bool");
...
PyDoc_STRVAR(doc_QX11Info_appDefaultVisual, "appDefaultVisual(screen: int = -1) -> bool");
...
PyDoc_STRVAR(doc_QX11Info_setAppDpiX, "setAppDpiX(int, int)");
...
PyDoc_STRVAR(doc_QX11Info_setAppDpiY, "setAppDpiY(int, int)");
...
PyDoc_STRVAR(doc_QX11Info_isCompositingManagerRunning, "isCompositingManagerRunning() -> bool");
...
static pyqt4ClassPluginDef plugin_QX11Info = {
    0,
    0,
    0
};
...
sipClassTypeDef sipTypeDef_QtGui_QX11Info = {
    {
        -1,
        0,
        0,
